            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 transition pr-11"
                  placeholder="••••••••"
                />
                <button
                  type="button"
          ...
          {!DEMO_MODE && (
            <>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border border-gray-200 bg-white hover:bg-gray-50 transition font-medium text-gray-700 text-sm"
              >
